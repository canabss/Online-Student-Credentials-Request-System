<?php
    ...
    use PHPMailer\PHPMailer\Exception;
                                        ...
                                        <div class = "frame">
                                            <div class = "frame-box">
                                                ...
                                                <div>
                                                    ...
                                                    <a class="confirm" style="color: white;" href="https://oscrs-bulsusc.com/accountConfirmation?employee_no='.$employeeNo.'&role='.$role.'">Confirm</a>
                                                </div><br><br>
                                                Regards,
                                                <br>BulSU-SC, OSCRS.
                                            </div>
                                        ...
                                        <div class = "frame">
                                            <div class = "frame-box">
                                                ...
                                                <div>
                                                    ...
                                                    <a class="confirm" style="color: white;" href="https://offices.oscrs-bulsusc.com">Login Now</a>
                                                </div><br><br>
                                                Regards,
                                                <br>BulSU-SC, OSCRS.
                                            </div>
        ...
        /*function sendQuery($studentNo, $completeName, $email, $message, $error){
            $mail = new PHPMailer(true);
            
            try {
                //Recipients
                $mail->setFrom($email, $completeName);
                $mail->addAddress('oscrstestemail@gmail.com');
                ...
                $mail->Body  = '<html>
                                    ...
                                    <body>
                                        <div class = "frame">
                                            <div class = "frame-box">
                                                <img class="logo" src = "https://oscrs-bulsusc.com/assets/img/BSU-w.png" alt = "Logo"/><br/><br/>
                                                <div>
                                                    <div>Hello, Registrar<br/><br/>'.$message.'<br/><br/>
                                                    </div><br/><br/>
                                                    
                                                </div><br/><br/>
                                                Regards,<br/>'.$completeName.' - '.$studentNo.'.
                                            </div>
                                        </div>
                                    </body>
                                </html>';
