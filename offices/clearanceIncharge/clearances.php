<?php
    ...
    if(!isset($_SESSION['user_id'])){
        header("Location: https://offices.oscrs-bulsusc.com/");
	    exit(); 
    }
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])){
        ...
        $id = $db->real_escape_string($_POST['clearanceId']);
        ...
        if($_SESSION['role'] == '2'){
            ...
            if($sql && $sql1){
                $text = "Your Clearance has been approved by the Dean's Office. Your clearance is completed then your request is now received by the registrar office. Please wait a little longer for your request, Thank you!";
                emailNotify1($id, $lastname, $firstname, $middlename, $email, $text);
            ...
            if($sql){
                $text = "Your Clearance has been approved by the Campus Secretary. Your clearance is now received by the Dean's Office, Thank you!";
                emailNotify1($id, $lastname, $firstname, $middlename, $email, $text);
                $_SESSION['success'] = true;
            }
            else{
            ...
            if($sql){
                $text = "Your Clearance has been approved by the Campus Accounting. Your clearance is now received by the Campus Secretary, Thank you!";
                emailNotify1($id, $lastname, $firstname, $middlename, $email, $text);
                $_SESSION['success'] = true;
            }
            else{
            ...
            if($sql){
                $text = "Your Clearance has been approved by your Department Head. Your clearance is now received by the Campus Clinic, Thank you!";
                emailNotify1($id, $lastname, $firstname, $middlename, $email, $text);
                $_SESSION['success'] = true;
            }
            else{
            ...
            if($sql){
                $text = "Your Clearance has been approved by your Adviser. Your clearance is now received by your Department Head, Thank you!";
                emailNotify1($id, $lastname, $firstname, $middlename, $email, $text);
                $_SESSION['success'] = true;
            }
            else{
            ...
            if($sql){
                $text = "Your Clearance has been approved by the Guidance Office. Your clearance is now received by the Campus Accounting, Thank you!";
                emailNotify1($id, $lastname, $firstname, $middlename, $email, $text);
                $_SESSION['success'] = true;
            }
            else{
            ...
            if($sql){
                $text = "Your Clearance has been approved by the Student Affairs Office. Your clearance is now received by the Guidance Office, Thank you!";
                emailNotify1($id, $lastname, $firstname, $middlename, $email, $text);
                $_SESSION['success'] = true;
            }
            else{
            ...
            if($sql){
                $text = "Your Clearance has been approved by the Campus Nurse. Your clearance is now received by the Library, Thank you!";
                emailNotify1($id, $lastname, $firstname, $middlename, $email, $text);
                $_SESSION['success'] = true;
            }
            else{
            ...
            if($sql){
                $text = "Your Clearance has been approved by the Library. Your Clearance is now received by the Student Affairs Office, Thank you!";
                emailNotify1($id, $lastname, $firstname, $middlename, $email, $text);
                $_SESSION['success'] = true;
            }
            else{
                                        ...
                                        ?>
                                            <?php foreach($clearances as $clearance) :?>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td>
                                                            <form method="POST">
                                                                <input type="hidden" name="studentNo" value="<?php echo $clearance["studentNo"];?>">
                ...
                <script type='text/javascript'>
                    Swal.fire({
                        ...
                        if(result.isConfirmed){
                            window.location.replace('clearances?id=<?php echo $_SESSION['user_id']?>');
                        }
                    });
                </script>
