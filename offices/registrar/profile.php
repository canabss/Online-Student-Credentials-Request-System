                            ...
                            <form method="POST" action="" enctype="multipart/form-data">
                                <div class = "preview-profile rounded mx-auto d-block">
                                    ...
                                    <div class="upload-wrapper">
                                        ...
                                        <input type="file" name="input-profile-img" id="input-profile-img" accept="image/png, image/gif, image/jpeg, image/jpg" onchange="previewProfilePicture(this);" required>
                                    </div>
                ...
                <div class="modal-dialog modal-md">
                        <div class="modal-content " style="margin-top: 130px;">
                            ...
                            <form method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="modal-footer justify-content-between">
                                    <button type="submit" class="btn btn-info mx-auto" name="save"  id="save-email"><i class='fa fa-check'></i> SAVE</button>
                                </div>
                            </form>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" placeholder="New Username" name="new-username" required><br>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer justify-content-between">
